            ...
            <div id="details-body">
                ...
                <div class="feature-section">
                    ...
                    <ul>
                        ...
                        <li><b>helmer_ecs</b>: the og! simple and suprisingly scalable.</li>
                        <li><b>anything you want</b>: hecs, flecs, EnTT, etc.. - integrate any library of your choice. but dont stop at ECS libraries: ECS, CBA, event-driven, etc.., you name it. helmer is what you make it.</li>
                    </ul>
                </div>
                ...
                <div class="feature-section">
                    ...
                    <ul>
                        ...
                        <li><b>on-demand LOD/mip generation</b>: helmer was designed to generate LODs at runtime. it is unnoticable. when over-budget (VRAM soft), the renderer will start to request lower quality derivatives of meshes/textures to relax VRAM pressure.</li>
                    </ul>
                </div>
                ...
                <div class="feature-section">
                    ...
                    <ul>
                        <li><b>any hardware</b>: helmer supports all major GPU backends, ensuring consistant support across platforms. helmer's speedy asset streaming & resource management allows for hardware of any tier/generation/limit to hit performance goals - and not at the expense of looks.</li>
